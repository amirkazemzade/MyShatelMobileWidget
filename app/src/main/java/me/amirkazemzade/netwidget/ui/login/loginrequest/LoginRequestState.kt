...
class LoginRequestState {
    ...
    fun validate(usernameRequiredMessage: String, captchaRequiredMessage: String): Boolean {
        usernameError = if (username.isBlank()) usernameRequiredMessage else null
        captchaError = if (captcha.isBlank()) captchaRequiredMessage else null
